	...
	$.fn.datetimepicker = function( opt ){
		...
		var createDateTimePicker = function( input ){
			...
			var datetimepicker = $('<div class="xdsoft_datetimepicker"></div>'),
				...
				mounth_picker = $('<div class="xdsoft_mounthpicker"><div class="xdsoft_label xdsoft_month"></div><div class="xdsoft_label xdsoft_year"></div><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_next"></button></div>'),
				calendar = $('<div class="xdsoft_calendar"></div>'),
				timepicker = $('<div class="xdsoft_timepicker active"><div class="ddset"></div><button type="button" class="xdsoft_prev"></button><div class="xdsoft_time_box"></div><button type="button" class="xdsoft_next"></button></div>'),
			...
			datetimepicker.on('change.xdsoft',function(){
				...
				var line_time = function (h,m){
					...
					time+= '<div class="'+
								...
								var daynm =  datetimepicker.data('xdsoft_datetime').currentTime.getDay();
				var dayname = Date.dayNames[daynm];
				var monthnm =  xd.currentTime.getMonth();
				var monthname = Date.monthNames[monthnm];
				var datenm = xd.currentTime.getDate();
				var monthname=new Array("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec");
                var monName = monthname[monthnm];
				$(".ddset").text(dayname+", "+monName+" "+datenm);
				};
			...
			calendar.on('mousedown.xdsoft','td',function(){
				...
				var daynm =  datetimepicker.data('xdsoft_datetime').currentTime.getDay();
				var dayname = Date.dayNames[daynm];
				var monthnm =  $(this).data('month');
				var monthname = Date.monthNames[monthnm];
				var datenm = $(this).data('date');
				var monthname=new Array("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec");
                var monName = monthname[monthnm];
				$(".ddset").text(dayname+", "+monName+" "+datenm);
			...
			timebox.on('mousedown.xdsoft','div',function(){
				...
				//$(".ddset").text(datetimepicker.data('xdsoft_datetime').str());
			});
